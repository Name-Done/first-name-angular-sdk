...
export * from './languageName.service';
import { LanguageNameService } from './languageName.service';
export * from './topLevelDomainName.service';
import { TopLevelDomainNameService } from './topLevelDomainName.service';
export const APIS = [DomainNameService, EmailDomainNameService, FamilyNameService, GenderService, GivenNameService, LanguageNameService, TopLevelDomainNameService];
